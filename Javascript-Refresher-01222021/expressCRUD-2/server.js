      ...
      <div class="jumbotron p-3 shadow-sm">
        <form id="create-form" action="/create-item" method="POST">
          <div class="d-flex align-items-center">
            <input id="create-field" name="userInput" autofocus autocomplete="off" class="form-control mr-3" type="text" style="flex: 1;">
...
app.post('/create-item', function (req, res) {
  db.collection("collection01262021").insertOne({userInputText: req.body.textFieldValue}, function(err, info) {
  // res.send("Success");
   res.json(info.ops[0]);
  })
});
